...
const Navigation = ({currentPage, setCurrentPage, imagesListLength}) => {
  const displayNavigationButton = (page) => {
    ...
    if(page === 'imageuploadform')
      return <p onClick={() => setCurrentPage('imageslistpage')} className='f3 b link dim black pa3 pointer scale-transformation'>Photos List ({imagesListLength})</p>
  }
  return (
