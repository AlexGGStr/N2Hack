        ...
        <article className="br5 ba b--black-10 mv4 w-100 w-50-m w-25-l mw8 shadow-5 center">
            <main className="pa4 black-80">
                <form className="measure">
                    ...
                    <div className="">
                    <input className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="button" value="Next" onClick={() => {savePerson(); setCurrentPage('imageuploadform')}}/>
                    </div>
